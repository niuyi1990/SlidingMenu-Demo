package com.soft.niuyi.slidingmenu.view;
...
import com.soft.niuyi.slidingmenu.R;
...
public class SlidingMenu extends HorizontalScrollView {
    ...
    public SlidingMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMenuRightPadding = typedArray.getDimensionPixelSize(R.styleable.SlidingMenu_rightPadding, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, mMenuRightPadding, context.getResources().getDisplayMetrics()));
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (changed) {
            ...
            //scrollTo移动时父view不动，scrollTo（100,0）指的是menu向右移动100位置
